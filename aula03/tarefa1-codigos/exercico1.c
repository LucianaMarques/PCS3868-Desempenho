...
#define Semaph sem_t
#include "type_exercico1.h"  /* typedef's */
#include "vgp_exercico1.h"   /* global privada*/
#include "vsl_exercico1.h"   /* shared local  */
#include "partask_exercico1.h"
